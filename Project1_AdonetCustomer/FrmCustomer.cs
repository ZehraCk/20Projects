...
namespace Project1_AdonetCustomer
{
    public partial class FrmCustomer : Form
    {
        ...
        SqlConnection sqlConnection = new SqlConnection("server=ZEHRA\\SQLEXPRESS; initial catalog=DbCustomer; integrated security=true");
        private void btnList_Click(object sender, EventArgs e)
        {
            ...
            rdbActive2.DataSource = dataTable;
