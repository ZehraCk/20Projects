...
if(number == "1")
{
    string url = "https://localhost:7224/api/Weathers";
...
if(number == "4")
{
    string url = "https://localhost:7224/api/Weathers?id=";
...
if (number == "5")
{
    ...
    if (number == "6")
    {
        string url = "https://localhost:7224/api/Weathers/GetByIdWeatherCity?id=";
    ...
    using (HttpClient client = new HttpClient())
    {
        ...
        string cityCountry = weatherCityObject["cityCountry"].ToString();
        decimal temp = decimal.Parse(weatherCityObject["temp"].ToString());

        Console.WriteLine("Girmiş Olduğunuz Id değerine ait bilgiler ");
        Console.WriteLine();
        Console.Write("Şehir:  "+cityName + " Ülke: "+ cityCountry+" Detay: "+detail + " Sıcaklık: "+temp);
    ...
    Console.WriteLine();
    Console.Read();
//https://localhost:7224/api/Weathers/GetByIdWeatherCity?id=9
