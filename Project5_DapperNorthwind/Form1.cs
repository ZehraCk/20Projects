...
namespace Project5_DapperNorthwind
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection connection = new SqlConnection("server=ZEHRA\\SQLEXPRESS; initial catalog=Db5Project20; integrated security=true;MultipleActiveResultSets=True");
        private async void Form1_Load(object sender, EventArgs e)
        {
            //Kategori Sayisi
            string query = "Select Count (*) From Categories";
            var categoryCount = connection.ExecuteScalar<int>(query);
