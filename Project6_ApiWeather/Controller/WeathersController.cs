...
namespace Project6_ApiWeather.Controller
{
    ...
    public class WeathersController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult CreateWeatherCity(Entities.City city)
        {
        ...
        [HttpPut]
        public IActionResult UpdateWeatherCity(Entities.City city)
        {
        ...
        public IActionResult TotalCityCount(int id)
        {
